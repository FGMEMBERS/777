...
var AIR = {
    ...
    update : func{
        ...
        if((cpt_flt_inst.getValue() < 24)
                or (getprop("engines/engine/running") and getprop("controls/air/lpack-switch")))
        {
        ...
        if((cpt_flt_inst.getValue() < 24)
                or (getprop("engines/engine[1]/running") and getprop("controls/air/rpack-switch")))
        {
        ...
        if((cpt_flt_inst.getValue() < 24)
                or (getprop("engines/engine/running") and getprop("controls/air/bleedengl-switch")))
        {
        ...
        if((cpt_flt_inst.getValue() < 24)
                or (getprop("engines/engine[1]/running") and getprop("controls/air/bleedengr-switch")))
        {
