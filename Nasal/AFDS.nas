...
#################
    getNextRestriction: func(curWp)
    {
        ...
        var i = curWp;
        var legWP = f.getWP(i);
        while((legWP.alt_cstr == 0) and (i < (getprop("autopilot/route-manager/route/num") - 1)))
        {
            i += 1;
            legWP = f.getWP(i);
        }
...
#                   tcNode.getNode("latitude-deg", 1).setValue(topClimb.lat);
        ...
        elsif(me.step==6)
        {
            ...
            if(banklimit==0)
            {
                ...
                {
                    lim=5;
                    me.heading_change_rate = 4.9;
                }
                elsif(ma_spd > 0.6666)
                {
                    lim=10;
                    me.heading_change_rate = 2.45;
                }
                elsif(ma_spd > 0.5)
                {
                    lim=20;
                    me.heading_change_rate = 1.125;
                }
                elsif(ma_spd > 0.3333)
                {
                    lim=30;
                    me.heading_change_rate = 0.625;
                }
                else
                {
                    lim=35;
                    me.heading_change_rate = 0.55;
                }
                me.heading_change_rate *= 0.5;
